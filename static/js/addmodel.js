...
// check if form is submitted
 ...
 $("#successAlert").hide();
        ...
        $("#model").on('submit',function(event){
        //use ajax to send data to python


                $.ajax({
                    data: {
                        input_model: $("#input_model").val() // get make value from html form

                     },
                     type: 'POST', // method to use
                     url: '/addmodel' // python route to destination
...
// after this file create a python route named / ad